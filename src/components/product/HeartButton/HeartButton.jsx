  ...
  return (
    ...
    >
      {isLiked ? (
        ...
        //   aria-hidden="true"
        // >
        //   <path d="M8 15.5C-6.56 5.88 3.84-1.61 8 2.67C12.16-1.61 22.56 5.88 8 15.5ZM8 13.9C11.22 11.69 13 9.66 13.86 7.97C14.75 6.21 14.64 4.83 14.15 3.88C13.11 1.85 10.23 1.29 8.67 2.9L8 3.59L7.33 2.9C5.77 1.29 2.89 1.85 1.85 3.88C1.36 4.83 1.25 6.21 2.14 7.97C3 9.66 4.78 11.69 8 13.9Z" />
        // </svg>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 16 16"
