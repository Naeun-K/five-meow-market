...
// // //       <S.DetailButton type="button" onClick={() => onViewDetail(order)}>
...
// // //   );
// // // }
// // function OrderCard({ order, onViewDetail, onClaim, onConfirm, isConfirming }) {
// //   const firstItem = order.items?.[0];
...
// //         {(canCancel || canDeliveryAction) && (
// //           <S.OrderActionButtons>
// //             {canCancel && (
// //               <S.OrderActionButton
// //                 type="button"
...
// //    * Mock 주문
// //    *
// //    * 실제 주문과 ID가 겹치면 제거합니다.
// //    */
// //   // let filteredMockOrders = mockOrderData.filter(
...
// //    * 순서로 합칩니다.
// //    *
// //    * 전체를 다시 날짜순 정렬하지 않기 때문에
// //    * 추후 실제 주문이 추가되어도
// //    * 실제 주문이 항상 Mock 주문보다 위에 있습니다.
// //    */
...
// //     /*
// //      * Mock 주문은 서버에 실제 주문이 없으므로
// //      * 현재 실제 주문 상세 API로 이동시키면
// //      * 404가 발생할 수 있습니다.
// //      *
// //      * 일단 Mock 여부를 state로 전달합니다.
// //      */
...
//  *
//  * 모든 액션 버튼은
//  * className="order-action-button" 사용
//  */
// function OrderCard({ order, onViewDetail, onClaim, onConfirm, isConfirming }) {
//   const firstItem = order.items?.[0];
  ...
  const handleWriteReview = (order) => {
    ...
    navigate(`/reviews?${searchParams.toString()}`, {
      state: {
        ...
        mockOrder: order.isMock ? order : undefined,
      },
    });
  };
