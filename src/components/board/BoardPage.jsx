...
//     case "number":
//       return (
//         <span className={item.isNotice ? "notice-number" : ""}>
//           {item.isNotice ? "공지" : item.number}
//         </span>
//       );
...
//     case "writer":
//       return <span>{item.writer}</span>;

//     case "date":
//       return <span className="date">{item.date}</span>;

//     case "views":
//       return <span className="views">{item.views}</span>;

//     case "rating":
//       return (
//         <Rating aria-label={`평점 ${item.rating}점`}>
//           {Array.from({ length: 5 }, (_, index) => (
//             <span key={index} className="svg-container">
//               {index < item.rating ? (
//                 <svg
