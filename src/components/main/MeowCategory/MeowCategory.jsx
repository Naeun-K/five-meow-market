...
const categories = [
  {
    ...
    image: logoEat,
    tags: ["#먹방요정", "#고양이먹거리"],
    path: "/products?categoryId=cat-eat",
  },
  {
    id: 2,
    name: "놀묘",
    image: logoPlay,
    tags: ["#장난꾸러기", "#내고양이는관심"],
    path: "/products?categoryId=cat-play",
  },
  {
    id: 3,
    name: "쉼묘",
    image: logoRest,
    tags: ["#잠꾸러기", "#고양이쉼터"],
    path: "/products?categoryId=cat-rest",
  },
  {
    id: 4,
    name: "높묘",
    image: logoHigh,
    tags: ["#점프킹", "#고양이집사"],
    path: "/products?categoryId=cat-high",
  },
  {
    id: 5,
    name: "깔묘",
    image: logoClean,
    tags: ["#왕감자", "#고양이화장실"],
    path: "/products?categoryId=cat-clean",
  },
];
