...
// // //         setOrderCount(orderData.pagination?.totalCount ?? 0);
...
// // //      마이페이지에는 찜한 상품만 존재하므로
// // //      하트를 누르면 DELETE /wishlist/:productId 실행 후
// // //      화면에서도 즉시 제거
// // //   ========================================================= */
...
// //      단,
// //      실제 주문과 Mock 주문의 orderId가 같으면
// //      Mock 주문은 중복 카운트하지 않음
// //   ========================================================= */
...
// //         /*
// //          * 마이페이지 주문 카드에는
// //          * 기존과 동일하게 실제 주문 최신 2개만 표시
// //          */
// //         setOrders(realOrders.slice(0, 2));
...
// //          * 실제 주문 ID 목록
// //          */
// //         const realOrderIds = new Set(realOrders.map((order) => order.orderId));

// //         /*
// //          * 실제 주문과 같은 orderId를 가진
// //          * Mock 주문은 중복이므로 제외
// //          */
...
// //          * Mock 주문 개수
// //          */
// //         setOrderCount(realOrderCount + availableMockOrders.length);
