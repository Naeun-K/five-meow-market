...
// // //         setOrderCount(result.pagination?.totalCount ?? 0);
// // //       } catch (error) {
...
// // //       if (!result.success) {
// // //         throw new Error(result.message || "구매결정에 실패했습니다.");
// // //       }
...
// // //     } catch (error) {
// // //       console.error("구매결정 실패:", error);

// // //       showToast(error.message || "구매결정에 실패했습니다.", false);
// // //     }
// // //   };
...
// // //                             <p>{formatPrice(product.itemAmount)}</p>
// // //                           </div>
// // //                         </div>
...
// // //                           {order.status === "DELIVERED" && order.canConfirm && (
// // //                             <button
// // //                               type="button"
...
// // //           <div className="section-content">
// // //             <span className="guide-message">밀어서 보기</span>
...
// //         if (!result.success) {
// //           throw new Error(result.message || "적립금을 불러오지 못했습니다.");
// //         }
...
// //         showToast(error.message || "적립금을 불러오지 못했습니다.", false);
// //       }
// //     };
...
//   //   fetchPoints();
//   // }, [isAuthLoading, accessToken, fetchPoints]);
...
//       // 구매결정 완료 후 최신 적립금 조회
//       const pointResult = await getPoints(accessToken);
