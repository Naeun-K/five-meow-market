...
//   //   await applyPoints(maximumPoints);
//   // };
...
//   //   const points = pointInput === "" ? 0 : Number(pointInput);
...
//         const pointResult = await checkoutService.applyCheckoutPoints(
//           checkoutId,
//           inputPoints,
//           accessToken,
//         );
...
//         const nextAppliedPoints = Number(
//           pointResult.appliedPoints ?? inputPoints,
//         );
...
//             pointResult.expectedPoint ?? prev.expectedPoint,
//           ),

//           finalAmount: Number(pointResult.finalAmount ?? prev.finalAmount),
//         }));
...
//                       onClick={handleUseAllPoints}
//                       disabled={isPointApplying || availablePoints <= 0}
//                     >
//                       전액사용
//                     </button>
